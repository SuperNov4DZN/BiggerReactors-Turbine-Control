...
function _G.initPeripherals()
	...
	for i = 1, #peripheralList do
		--Turbines
		if peripheral.getType(peripheralList[i]) == "BigReactors-Turbine" then -- <-- Had to change this to --> "bigger-turbine"
			...
			--Reactor
		elseif peripheral.getType(peripheralList[i]) == "BigReactors-Reactor" then -- <-- And this --> "bigger-reactor"
